	...
	<div class="right">
		...
		<div class="header">
			<a href="perfil.php?uid=<?php echo $userId?>">
				<?php echo $userNome ?></a> adicionou <?php echo $nFotos ?> fotos em <a href="albuns.php?uid=<?php echo $userId?>&aid=<?php echo $albumId?>"><?php echo $albumTitulo?></a></div>
		...
		<div class="imagens">
			<ul class="nFotos<?=$nFotos>4?4:$nFotos?>">
				...
				<li><a href="albuns.php?uid=<?php echo $userId?>&aid=<?php echo $albumId?>&fid=<?php echo $fotoId ?>">
					<img src="uploads/fotos/200/<?php echo $fotoSRC ?>" /></a></li>
